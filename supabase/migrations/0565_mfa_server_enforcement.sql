-- ── 0565 · Server-side MFA enforcement primitive + opt-in on settings ─────────
--
...
-- Each re-issued from its live definition (0201 / 0203 / 0563) with one added
...
begin
  if to_regclass('private.rr_migrations') is not null then
    ...
    values ('0565_mfa_server_enforcement.sql')
