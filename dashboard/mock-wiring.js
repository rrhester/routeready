...
// injection time).
  ...
  function goto(view){
    ...
    var contexts = {
      ...
      repair: 'Repair cases · quotes · in-shop tracking',
  ...
  function openDriverDetail(name, station, tenure, score, attendance){
    ...
    if (!(rosterSub && rosterSub.offsetParent !== null)) {
      ...
      if (driversView && !driversView.classList.contains('active') && typeof goto === 'function') {
        try { window._rrGotoSubIntent = { view: 'schedule', sub: 'roster' }; goto('schedule'); } catch (_e) {}
      }
  ...
  function ivAction(btn, action, candidateName, extra){
    ...
    if (action === 'Hired') {
      ...
      if (notifList) {
        ...
        notif.onclick = function(){ window._rrGotoSubIntent = { view: 'schedule', sub: 'roster' }; goto('schedule'); closePopovers(); };
