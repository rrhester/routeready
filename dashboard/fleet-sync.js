...
(() => {
  ...
  function injectStyles() {
    ...
    #rr-ps-dock .rr-ps-dhead { display:flex; align-items:center; gap:8px; padding:11px 13px; background:linear-gradient(180deg,#2563EB,#1D4ED8); color:#fff; cursor:pointer; }
