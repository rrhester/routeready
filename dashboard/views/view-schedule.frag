            ...
            <div class="sched-vans-rules-split">
              ...
              <div class="sched-vans-rules-popover" id="rr-sched-vans-rules-popover" role="dialog" aria-modal="false" aria-label="Van rules" hidden>
                ...
                <div class="sched-smartfill-rules-body sf-zone--vans" style="column-count:1;display:flex;flex-direction:column;gap:8px;padding:12px 14px">
                  ...
                  <label class="sched-smartfill-rule"><input type="checkbox" id="rr-set-auto-van-assign" data-rr-fleet-setting="auto_van_assign" data-rr-sf-vans="assign" checked> <span class="sf-rule-name">Auto-assign vans to scheduled drivers <button type="button" class="rr-pol-info" data-rr-pol-info="Fills every 'No van' gap from your active + spare pool — both when the Today's Plan page opens and during Smart Fill on the schedule grid. When off, the van column stays empty until you assign manually." aria-label="What this rule does"><svg viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" aria-hidden="true"><circle cx="6" cy="6" r="4.8"/><line x1="6" y1="5.4" x2="6" y2="8.6"/><circle cx="6" cy="3.3" r="0.6" fill="currentColor" stroke="none"/></svg></button></span></label>
