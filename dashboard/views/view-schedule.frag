      ...
      <div class="page tcp-shell">
        ...
        <!-- style block 27 extracted to inline-styles.css -->
          ...
          <div class="rr-ab" id="rr-sched-actionbar" role="toolbar" aria-label="Schedule actions">
            ...
            <!-- App launcher · Google-style grid menu next to the coverage card
                 (operator). Each item reuses the existing navigation: goto(view)
                 for top-level destinations, or goto('schedule') + the sidebar
                 sub-nav for the schedule sub-views (Roster / Today / Requests). -->
            <div class="rr-applauncher" id="rr-applauncher">
              <button type="button" class="rr-al-btn" id="rr-al-btn" aria-haspopup="menu" aria-expanded="false" title="App launcher" aria-label="App launcher">
                <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><circle cx="5" cy="5" r="1.8"/><circle cx="12" cy="5" r="1.8"/><circle cx="19" cy="5" r="1.8"/><circle cx="5" cy="12" r="1.8"/><circle cx="12" cy="12" r="1.8"/><circle cx="19" cy="12" r="1.8"/><circle cx="5" cy="19" r="1.8"/><circle cx="12" cy="19" r="1.8"/><circle cx="19" cy="19" r="1.8"/></svg>
              </button>
              <div class="rr-al-panel" id="rr-al-panel" role="menu" hidden>
                <div class="rr-al-col">
                  <div class="rr-al-colhd">Operations</div>
                  <button type="button" class="rr-al-item" role="menuitem" data-al-go="schedule"><span class="rr-al-ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="3" y1="10" x2="21" y2="10"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="16" y1="2" x2="16" y2="6"/></svg></span><span class="rr-al-lbl">Schedule</span></button>
                  <button type="button" class="rr-al-item" role="menuitem" data-al-sub="roster"><span class="rr-al-ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg></span><span class="rr-al-lbl">Roster</span></button>
                  <button type="button" class="rr-al-item" role="menuitem" data-al-sub="today"><span class="rr-al-ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><rect x="8" y="2" width="8" height="4" rx="1"/><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><path d="M9 14l2 2 4-4"/></svg></span><span class="rr-al-lbl">Today</span></button>
                  <button type="button" class="rr-al-item" role="menuitem" data-al-go="okami"><span class="rr-al-ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><line x1="6" y1="20" x2="6" y2="14"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="18" y1="20" x2="18" y2="10"/></svg></span><span class="rr-al-lbl">Forecast</span></button>
                </div>
                <div class="rr-al-col">
                  <div class="rr-al-colhd">People</div>
                  <button type="button" class="rr-al-item" role="menuitem" data-al-go="drivers"><span class="rr-al-ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg></span><span class="rr-al-lbl">Drivers</span></button>
                  <button type="button" class="rr-al-item" role="menuitem" data-al-go="onboarding-ops"><span class="rr-al-ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="4" width="20" height="16" rx="2"/><circle cx="8.5" cy="10" r="2"/><path d="M14 9h4M14 13h4M5.5 16a3 3 0 0 1 6 0"/></svg></span><span class="rr-al-lbl">Onboarding</span></button>
                  <button type="button" class="rr-al-item" role="menuitem" data-al-sub="requests"><span class="rr-al-ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><rect x="8" y="2" width="8" height="4" rx="1"/><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><line x1="9" y1="12" x2="15" y2="12"/><line x1="9" y1="16" x2="13" y2="16"/></svg></span><span class="rr-al-lbl">Requests</span></button>
                </div>
                <div class="rr-al-col">
                  <div class="rr-al-colhd">Business</div>
                  <button type="button" class="rr-al-item" role="menuitem" data-al-go="fleet2"><span class="rr-al-ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><rect x="1" y="3" width="15" height="13" rx="1.5"/><path d="M16 8h4l3 3v5h-7z"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg></span><span class="rr-al-lbl">Fleet</span></button>
                  <button type="button" class="rr-al-item" role="menuitem" data-al-go="messages"><span class="rr-al-ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8z"/></svg></span><span class="rr-al-lbl">Messages</span></button>
                  <button type="button" class="rr-al-item" role="menuitem" data-al-go="email"><span class="rr-al-ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="M22 6l-10 7L2 6"/></svg></span><span class="rr-al-lbl">Email</span></button>
                  <button type="button" class="rr-al-item" role="menuitem" data-al-go="admin"><span class="rr-al-ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></span><span class="rr-al-lbl">Admin</span></button>
                </div>
              </div>
            </div>
            <script>
              (function () {
                var L = document.getElementById('rr-applauncher');
                ...
                panel.addEventListener('click', function (e) {
                  ...
                  var go = it.getAttribute('data-al-go'); var sub = it.getAttribute('data-al-sub');
                  close();
                  try {
                    if (go && window.goto) { window.goto(go); }
                    else if (sub) {
                      if (window.goto) window.goto('schedule');
                      var b = document.querySelector('.nav-sub-item[data-key="' + sub + '"]');
                      if (b) b.click();
                    }
                  } catch (_) {}
                });
