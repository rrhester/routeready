...
// SHA-256 is implemented in pure TypeScript so the engine runs unchanged
// in Node and in the browser (no node:crypto dependency).
...
function sha256Hex(input: string): string {
  ...
  dv.setUint32(total - 8, Math.floor(bitLen / 0x1_0000_0000), false);
